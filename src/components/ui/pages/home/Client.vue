...
export default {
  ...
  data() {
    return {
      clients: [
        {
          imgURL: require("../../../../assets/img/companies/zine.png"),
          alt: "zine-client",
        },
        {
          imgURL: require("../../../../assets/img/companies/zine-cereales.jpg"),
          alt: "zine-client",
        },
        {
          imgURL: require("../../../../assets/img/companies/itqan.png"),
          alt: "itqan-client",
        },
        {
          imgURL: require("../../../../assets/img/companies/lgmz.jpg"),
          alt: "lgmz-client",
        },
        {
          imgURL: require("../../../../assets/img/companies/lgsz.jpg"),
          alt: "lgsz-client",
        },
        {
          imgURL: require("../../../../assets/img/companies/bmz.png"),
          alt: "bmz-client",
        },
      ],
    };
      ...
      <div class="row">
        ...
        >
          <div class="card-body d-flex flex-column justify-content-center">
            <h1
              class="font-s12 font-md-s10 font-sm-s8 text-capitalize text_bold"
            >
