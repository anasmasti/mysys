...
export default {
  ...
  data() {
    return {
      clients: [
        {imgURL: require('../../../../assets/img/companies/zine.png'), alt: 'zine-client'},
        {imgURL: require('../../../../assets/img/companies/zine-cereales.jpg'), alt: 'zine-client'},
        {imgURL: require('../../../../assets/img/companies/itqan.png'), alt: 'itqan-client'},
        {imgURL: require('../../../../assets/img/companies/lgmz.jpg'), alt: 'lgmz-client'},
        {imgURL: require('../../../../assets/img/companies/lgsz.jpg'), alt: 'lgsz-client'},
        {imgURL: require('../../../../assets/img/companies/bmz.png'), alt: 'bmz-client'},
      ]
    }
  } // data
}
