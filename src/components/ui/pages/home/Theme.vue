  ...
  <div id="themes">
    ...
    <div class="m-cards" id="mCards">
      ...
      <div
        class="m-card"
        :key="themeIdx"
        v-for="(theme, themeIdx) in themes_by_domaine.slice(begin, end)"
      >
        ...
        <div class="m-card-content">
          <h2 class="font-lg-8 font-md-s6 font-sm-4 font-s6 text_bold">
            {{ theme.name }}
          </h2>
          ...
          <router-link
            ...
            :to="{
              name: 'allformation',
              params: {
                theme_param: theme.id,
                domaine_param: theme.mysysdomain_id,
              },
            }"
          >
            En savoir plus
    ...
    <div class="row p-2 d-flex justify-content-center">
      <a
        class="font_sm font-weight-light"
        v-on:click="ShowMoreLess(begin, end)"
        id="showMoreBtn"
  ...
  methods: {
    ...
    ShowMoreLess(begin, end) {
      ...
      if (begin === 0 && end === 7) {
        ...
        document
          .getElementById("setShadow")
          .classList.remove("show_more_shadow");
