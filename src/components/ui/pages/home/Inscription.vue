      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <span class="modal-title h1" id="exampleModalLabel"
              >S'inscrire</span
            >
            <button
              type="button"
                ...
                <div class="row">
                  <div class="col-12 p-2">
                    ...
                    <select
                      ...
                      id="domaine"
                      v-model="domaineId"
                      v-on:change="FindThemesByDomaine(domaineId)"
                    >
                      <option
                  ...
                  <div class="col-12 p-2">
                    ...
                    <select
                      ...
                      id="theme"
                      v-model="themeId"
                      v-on:change="FindFormationByTheme(themeId)"
                    >
                      <option
                        v-for="(thm, themeIndex) in themes_by_domaine"
                        :key="themeIndex"
                        :value="thm.id"
                      >
                        {{ thm.name }}
                  ...
                  <div class="col-12 p-2">
                    <label for="formation" class="col-form-label"
                      >Formation</label
                    >
                    <select
                      class="form-control"
                    ...
                    >
                      <option
                        v-for="(form, formIndex) in formations_by_theme"
                        :key="formIndex"
                        :value="form.id"
                      >
                        {{ form.name }}
...
export default {
  ...
  methods: {
    ...
    async FetchAPI(dom_url, thm_url, form_url) {
      ...
      await this.axios
        .get(form_url)
        .then((res) => (this.formations = res.data));
