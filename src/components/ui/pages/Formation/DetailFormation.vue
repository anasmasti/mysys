  ...
  <div id="detailFormation">
    ...
    <div class="container-fluid m-0 p-0">
      <section class="formation-section bg_dark" id="formaSection">
        <div class="row pt-4">
          <div
            class="col-xl-8 col-lg-8 col-md-7 col-12 w-100 pr-lg-5 pr-md-5 pr-0 py-5"
          >
            <span
              :class="formation_by_id.certif ? 'badge badge-success my-3' : ''"
            >
              {{ formation_by_id.certif ? "• Certificat disponible" : "" }}
            </span>
            <span
              :class="
                formation_by_id.global_event ? 'badge badge-warning my-3' : ''
              "
            >
              {{
            ...
            <div class="d-flex flex-wrap align-items-center">
              ...
              <span class="font-weight-light"> Formateur : </span>
            ...
            <div class="d-flex flex-wrap align-items-center">
              ...
              <span class="font-weight-light"> Durée : </span>
              <span class="text-bold">
            ...
            <span class="badge badge-primary mt-3"
              >+ 52 participants inscrits</span
            >
            <div class="w-100 mt-2">
              <button
                class="btn btn-outline-light font_sm btn-sm ml-0"
                data-target="#inscriptionModal44"
                data-toggle="modal"
              >
                Partager <i class="fa fa-share"></i>
              </button>
              <button
                @click="ScrollUserTo('programme')"
                class="btn btn-outline-light font_sm btn-sm ml-0"
              >
                Voir le programme
              </button>
          ...
          <div class="col-xl-4 col-lg-4 col-md-5 col-12 ml-auto">
            <div
              class="d-card"
              id="formationCard"
              v-if="formation_by_id && is_formationsByThemeLoaded"
            >
              <div class="d-card-header">
                <img
                  class="d-card-img"
                  :src="formation_by_id.url_img"
              ...
              <div class="d-card-content">
                <h3 class="text_bold d-inline">
                  {{
                    formation_by_id.prix
                      ? formation_by_id.prix + " MAD"
                      : "Contactez-nous"
                  }}
                </h3>
                <h6 class="font-weight-light d-inline text-secondary">
                  <del>
                    {{
                      formation_by_id.prix_off
                        ? formation_by_id.prix_off + " MAD"
                        : ""
                    }}</del
                  >
                </h6>
                <span
                  class="font-weight-light text-secondary d-flex align-items-center"
                >
                  ...
                  <small>
                    {{
                      formation_by_id.prix && formation_by_id.prix_off
                        ? (
                            (formation_by_id.prix * 100) /
                            formation_by_id.prix_off
                          ).toFixed(0) + "% de réduction"
                        : "--"
                    }}
                  </small>
                </span>
                <!-- <div class="d-flex"> -->
                <button
                  class="btn btn-outline-primary btn-block btn-lg mx-0"
                  data-target="#inscriptionModal2"
                  data-toggle="modal"
                >
                  S'inscrire
                </button>
                <router-link
                  to="/contact"
                  class="btn btn-outline-dark btn-block btn-lg mx-0"
                ...
                <div class="w-100 my-3">
                  ...
                  <span class="d-flex flex-wrap">
                    <small class="material-icons h6 mb-0 pr-1"
                      >error_outline</small
                    >
            ...
            <div
              v-else
              class="d-card d-flex flex-nowrap align-items-center justify-content-center"
              id="formationCard"
            >
              <img
                class="loading"
                :src="require('../../../../assets/img/loading2.gif')"
                alt="loading ui"
              />
            </div>
          </div>
    ...
    <div class="container-fluid py-4">
      <div class="main-title">
        <span class="title font-lg-s8 font-md-s8 font-s6"
          >Ce que vous allez apprendre</span
        >
      </div>
      <div class="row">
        <div
          id="objectif"
          class="col-xl-7 col-lg-7 col-md-12 col-12 rounded-right bg_light_2 p-4"
        >
          <!-- objectif convertis -->
      ...
      <div class="row px-xl-5 px-md-5 px-sm-4 px-4">
        <div
          class="col-xl-7 col-lg-7 col-md-12 col-12 mb-5 pr-3"
          id="programme"
        >
          <!-- programme convertis -->
    ...
    <div
      id="formaBanner"
      class="w-100 d-flex flex-nowrap justify-content-between align-items-center bg_dark px-lg-4 px-2"
    >
      ...
      <div class="d-flex align-items-center">
        <span class="font-lg-s6 font-md-s6 font-s4 mx-2 prix">
          {{
            formation_by_id.prix
              ? Math.floor(formation_by_id.prix).toFixed(0) + " MAD"
              : "Contactez-nous"
          }}
        </span>
        <button
        ...
        <button class="btn btn-secondary d-sm-inline-block d-none">
          Contactez
        </button>
      </div>
    </div>
    ...
    <inscription-modal
      v-if="is_formationsByThemeLoaded"
      :formation="formation_by_id"
    >
    </inscription-modal>
...
export default {
      ...
      dataTransform: [
        {
          ...
          tag: "h3",
          classes:
            "subtitle font-lg-s7 font-md-s7 font-s5 text-capitalize mt-4",
          addition: "",
        }, // section title
        {
          symbol: "&&",
          tag: "h4",
          classes: "text_mysyscolor1 font-lg-s6 font-md-s6 font-s5 mt-4 mb-2",
          addition: "⬢ ",
        }, // subtitle bold
        {
          symbol: "@@",
          tag: "ul",
          classes: "d-flex flex-row flex-wrap list-unstyled font-weight-bold",
          addition: "",
        }, // ul list container
        {
          symbol: "__",
          tag: "li",
          classes:
            "font-weight-light pl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-1",
        ...
        }, // li list element
        {
          ...
          tag: "li",
          classes:
            "font-weight-light pl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-2",
          addition: '<strong class="text_mysyscolor1">✔ </strong>',
        },
  ...
  beforeDestroy() {
    ...
    // @ts-ignore
    window.removeEventListener("scroll", this.DisplayCardOnScroll, {
      passive: true,
    });
  },
  // ######### CREATED #########
  async mounted() {
    ...
    await this.$store.dispatch(
      "formationStore/setFormationById",
      this.form_param
    );
    await this.$store.dispatch(
  ...
  watch: {
    ...
    $route: async function (to, from) {
      if (to !== from) {
        ...
        await this.$store.dispatch(
          "formationStore/setFormationsByTheme",
          this.formation_by_id.mysystheme_id || 1
        );
