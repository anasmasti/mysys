      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title" id="inscriptionModalLabel">
              S'inscrire à {{ formation.name }}
            </h1>
            <button
              type="button"
              class="close"
              ...
              <form @submit="HandleRegister" method="POST">
                ...
                <div class="row">
                  <div class="col-12 p-2">
                    <label for="tele" class="col-form-label"
                ...
                <div class="row my-3">
                  <div class="col-6 p-2">
                    <label for="type" class="col-form-label"
                      >Vous êtes? <span class="text-danger">*</span></label
                    >
                    <select
                      class="form-control"
                      name="type"
